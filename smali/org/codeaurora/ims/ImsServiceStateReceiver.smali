...
# instance fields
.field private mAndroidCallId:I
...
.field private mSpeechCodec:I

.field private mSpeechSampFreq:I
...
.method public constructor <init>(Lorg/codeaurora/ims/ImsServiceSub;Landroid/content/Context;I)V
    ...
    iput v1, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mPhoneId:I

    .line 51
    const/4 v1, 0x0

    iput-object v1, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mNotificationMgr:Landroid/app/NotificationManager;

    .line 65
    iput v0, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mAndroidCallId:I

    .line 66
    iput v0, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mSpeechCodec:I

    .line 67
    iput v0, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mNetworkMode:I

    .line 68
    iput v0, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mSpeechSampFreq:I
...
# virtual methods
.method public getAndroidCallId()I
    .locals 1

    .line 195
    iget v0, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mAndroidCallId:I
...
.method public getNetworkMode()I
    ...
    .line 203
    iget v0, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mNetworkMode:I

    return v0
.end method

.method public getSpeechCodec()I
    .locals 1

    .line 199
    iget v0, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mSpeechCodec:I
...
.method public getSpeechSampFreq()I
    ...
    .line 207
    iget v0, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mSpeechSampFreq:I
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v8, "SimStateReceiver sub id from intent : "
    ...
    invoke-virtual {v6}, Lorg/codeaurora/ims/ImsServiceSub;->isVideoSupported()Z

    move-result v6

    iget-object v8, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mServiceSub:Lorg/codeaurora/ims/ImsServiceSub;

    invoke-virtual {v8}, Lorg/codeaurora/ims/ImsServiceSub;->isVoiceSupported()Z

    move-result v8

    invoke-virtual {p0, v6, v8}, Lorg/codeaurora/ims/ImsServiceStateReceiver;->updateHDIcon(ZZ)V

    .line 233
    iget-object v6, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mServiceSub:Lorg/codeaurora/ims/ImsServiceSub;

    invoke-virtual {v6}, Lorg/codeaurora/ims/ImsServiceSub;->onIccLoaded()V
    ...
    invoke-virtual {v5}, Lorg/codeaurora/ims/ImsServiceSub;->isVideoSupported()Z
    ...
    invoke-virtual {p0, v5, v6}, Lorg/codeaurora/ims/ImsServiceStateReceiver;->updateHDIcon(ZZ)V
    ...
    const-string v5, "qualcomm.intent.action.ACTION_SPEECH_CODEC_INFO_IND"
    ...
    iput v4, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mAndroidCallId:I

    .line 249
    const-string v4, "SpeechCodec"

    invoke-virtual {p2, v4, v7}, Landroid/content/Intent;->getIntExtra(Ljava/lang/String;I)I

    move-result v4

    iput v4, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mSpeechCodec:I
    ...
    iput v4, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mNetworkMode:I

    .line 251
    const-string v4, "SpeechSampFreq"

    invoke-virtual {p2, v4, v7}, Landroid/content/Intent;->getIntExtra(Ljava/lang/String;I)I

    move-result v4

    iput v4, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mSpeechSampFreq:I
    ...
    const-string v5, "mAndroidCallId:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v5, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mAndroidCallId:I

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v5, " mSpeechCodec:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v5, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mSpeechCodec:I
    ...
    iget v5, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mNetworkMode:I

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v5, " mSpeechSampFreq:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v5, p0, Lorg/codeaurora/ims/ImsServiceStateReceiver;->mSpeechSampFreq:I
